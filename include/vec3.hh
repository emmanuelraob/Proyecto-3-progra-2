...
inline vec3 cross(const vec3 &u, const vec3 &v) {
  ...
  __m256d result_x =
      _mm256_sub_pd(_mm256_mul_pd(u_1, v_2), _mm256_mul_pd(u_2, v_1));
  __m256d result_y =
      _mm256_sub_pd(_mm256_mul_pd(u_2, v_0), _mm256_mul_pd(u_0, v_2));
  __m256d result_z =
      _mm256_sub_pd(_mm256_mul_pd(u_0, v_1), _mm256_mul_pd(u_1, v_0));
