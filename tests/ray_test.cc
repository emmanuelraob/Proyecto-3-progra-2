...
//Dariel
//Prueba que se genere el vector hacia donde apunta el rayo con cierta longitud t correctamente
...
//Dariel
//Prueba que el vector hacia donde apunta el rayo con una distancia t sea distinta de un vector random
...
//uso de chatgpt para ello, pasan a la primera sin necesidad de hacer cambios mayores
