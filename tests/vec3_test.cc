...
//Dariel
//Prueba la generacion de un vector random con un minimo y un maximo para sus dimensiones
...
//Dariel
//Prueba que al menos una dimension de los vectores se encuentra un poco lejos del 0
...
//Dariel
//Prueba que no generen vectores al azar que no estan relacionados a su vector unitario
//Emmanuel, cambios menores para finalizar la pruebra de branches
...
TEST(Vec3Test, TotalTest){
    ...
    EXPECT_TRUE(compare_vectors(resultado, vec3(8737/1458.0, 4363/1458.0, 718/729.0)));
}
